...
for (Nc in c(2,5)){## LOOP on the number of clusters
...
nom = paste0(resfolder,"/FIXE_CLUST_N",NN,"_nc",N,"NumC_",Nc,"_CASE",str)

## generate
SEED = SEEDr[it]
source("./utils/run_extract_multiCluster_Europe.R")

## define the training dataset
load(paste0(outfolder,"/OCSdata_clust_train_Nc", Nc,".Rdata"))
